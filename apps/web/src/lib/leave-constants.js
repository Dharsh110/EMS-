...
export const LEAVE_LIMITS = { 'Casual Leave': 10, 'Sick Leave': 6, 'Earned Leave': 15, 'Maternity Leave': 90, 'Paternity Leave': 15, 'Emergency': 2, 'Compensatory Leave': 3 };
export const LEAVE_ICONS = { 'Casual Leave': '☀️', 'Sick Leave': '🤒', 'Earned Leave': '🏖️', 'Maternity Leave': '👶', 'Paternity Leave': '👨‍👧', 'Emergency': '🚨', 'Compensatory Leave': '⏰' };
...
export function computeLeaveBalance(leaves) {
