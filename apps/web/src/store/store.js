...
export const store = configureStore({
    ...
    middleware: (getDefaultMiddleware) => getDefaultMiddleware().concat(employeesApi.middleware, departmentsApi.middleware, attendanceApi.middleware, leavesApi.middleware, tasksApi.middleware, payrollApi.middleware, messagesApi.middleware, dailyReportsApi.middleware, calendarApi.middleware, uploadsApi.middleware, timesheetsApi.middleware),
});
