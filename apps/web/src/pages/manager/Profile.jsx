...
export default function ManagerProfile() {
    ...
    const teamAttendanceRate = today?.summary?.totalEmployees
        ...
        : 0;
    return (<ProfilePage roleLabel="Manager" gradient="from-blue-600 to-indigo-700" accent="text-blue-600" quickStats={[
        ...
        ]} skills={['Team Leadership', 'Agile/Scrum', 'Project Management', 'Code Review', 'Performance Management', 'Mentoring', 'Sprint Planning', 'Stakeholder Communication']} emergencyContact={[['Name', 'Lakshmi Kumar'], ['Relationship', 'Spouse'], ['Phone', '+91 98765 43211']]}/>);
}
