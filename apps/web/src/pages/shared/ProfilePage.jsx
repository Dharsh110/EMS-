...
export default function ProfilePage({ roleLabel, gradient, accent, quickStats, skills, emergencyContact }) {
    const { user } = useAuth();
    ...
    const blank = {
        ...
        department: user?.department || '', empId: '', joined: '', gender: '', dob: '',
        address: '', blood: '', bio: '',
    };
    ...
    useEffect(() => {
        ...
        const p = {
            ...
            department: typeof apiProfile.department === 'object' ? apiProfile.department?.name || '' : apiProfile.department || user?.department || '',
    ...
    const handleAvatar = (e) => {
        ...
        reader.onload = async (ev) => {
            ...
            setAvatar(b64);
            try {
                await updateMyProfile({ avatar: b64 }).unwrap();
    ...
    return (<div className="max-w-3xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {quickStats.map((s) => (<div key={s.l} className={`border border-gray-200 dark:border-gray-700 rounded-2xl p-3.5 text-center ${s.c}`}>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
        ...
        <div className="p-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {fields.map(([label, key, type]) => (<div key={key}>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {emergencyContact.map(([l, v]) => (<div key={l}>
