...
export default function ForgotPassword() {
    ...
    return (<div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 relative transition-colors duration-300">
      {/* Blobs */}
      ...
      <div className="w-full max-w-sm relative z-10 animation-fade-in">
        ...
        {!sent ? (<div className="bg-white dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700/60 rounded-2xl shadow-xl shadow-gray-200/60 dark:shadow-none p-6 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" placeholder="you@company.com" className={`w-full pl-10 pr-4 py-2.5 rounded-xl border text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 transition-all ${errors.email ? 'border-red-400 focus:ring-red-400/30' : 'border-gray-200 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-400/20'}`} {...register('email', { required: 'Email is required', pattern: { value: /^\S+@\S+\.\S+$/, message: 'Invalid email address' } })}/>
                </div>
          ...
          </div>) : (<div className="bg-white dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700/60 rounded-2xl shadow-xl shadow-gray-200/60 dark:shadow-none p-6 text-center animation-fade-in backdrop-blur-sm">
            ...
            {devResetUrl && (<div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-3 text-left mb-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 text-left mb-4 space-y-2">
              ...
              {['Check your spam or junk folder', 'Make sure the email address is correct', 'Wait a minute then try again'].map(tip => (<div key={tip} className="flex items-center gap-2">
