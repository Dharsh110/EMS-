...
export default function AdminProfile() {
    ...
    const attendanceRate = today?.summary?.totalEmployees
        ...
        : 0;
    return (<ProfilePage roleLabel="Administrator" gradient="from-purple-600 to-indigo-700" accent="text-purple-600" quickStats={[
        ...
        ]} skills={['System Administration', 'Network Security', 'Cloud Infrastructure', 'Database Management', 'ITIL Certified', 'AWS Solutions Architect', 'HR Operations', 'Compliance']} emergencyContact={[['Name', 'Meena Raj'], ['Relationship', 'Spouse'], ['Phone', '+91 98765 00002']]}/>);
}
